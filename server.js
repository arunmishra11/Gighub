...
const SequelzeStore = require('connect-session-sequelize')(session.Store); // Import the Sequelize store for session storage
...
app.engine('handlebars', hbs.engine); // Define template engine to use
